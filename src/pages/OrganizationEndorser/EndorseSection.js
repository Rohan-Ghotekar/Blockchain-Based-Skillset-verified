  ...
  handleSkillEndorse = async (e) => {
    ...
    if (AdminData) {
      ...
      try {
        ...
        // Send notification to employee after endorsement
        await messageAdmin(
          { name: "Employee Endorsement", ethAddress: employee_address },
          `You have been endorsed for ${section === 1 ? "Education" : section === 2 ? "Work Experience" : "Certification"}!`
        );
      } catch (err) {
